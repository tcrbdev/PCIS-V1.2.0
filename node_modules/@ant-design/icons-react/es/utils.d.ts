import { AbstractNode, IconDefinition, IconDefinitionGetter } from '@ant-design/icons/lib/types';
export declare function log(message: string): void;
export declare function isIconDefinition(target: any): target is IconDefinition;
export declare function isIconDefinitionGetter(target: any): target is IconDefinitionGetter;
